...
public class eliminar extends javax.swing.JPanel {
     ...
     */
    public eliminar(TiendaController controller) {
        initComponents();
    ...
    private void initComponents() {
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 49,
                                                        Short.MAX_VALUE)
                                                .addComponent(botonEliminarTraje,
        ...
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(tituloEliminar, javax.swing.GroupLayout.PREFERRED_SIZE, 33,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botonEliminarTrajeActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botonEliminarTrajeActionPerformed
        ...
        if (controller.eliminarTraje(nombretxt.getText())) {
         ...
         * 
         * boolean confirmar = 1 != JOptionPane.showConfirmDialog(this,
         * "Dulce: "+dulceResultado.toString(), "¿Seguro de eliminar el dulce?",
         ...
         * return;
         * }else{
         * JOptionPane.showMessageDialog(this,"No se encontro el dulce: "+nombretxt.
         * getText());
         * return;
         * }
         */
